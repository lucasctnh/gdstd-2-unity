...
namespace NobleConnect.Mirror
{
    public class NobleNetworkManager : NetworkManager
    {
        ...
        /// but still call Mirror's internal connect method.
        /// </remarks>
        public Action<NetworkConnection> onServerConnectInternal;
        ...
        override public void Awake()
        {
            ...
            onServerConnectInternal = (Action<NetworkConnection>)Delegate.CreateDelegate(typeof(Action<NetworkConnection>), this, onServerConnectInternalMethod);
        ...
        IEnumerator FixMirrorEvents()
        {
            ...
            // that the Mirror functions are also still called.
            var onConnectedProp = typeof(NetworkServer).GetField("OnConnectedEvent", BindingFlags.Static | BindingFlags.NonPublic);
            onConnectedProp.SetValue(null, new Action<NetworkConnection>(OnServerConnectInternal));
        }
